...
for i in range(len(State)) :
    for currency in Curency :
        for time in textTime :
            ...
            # x_new_test = x.tail(100).copy()
            # y_new_test = y.tail(100).copy()
            ...
            # if 1.0 in y_new_test.value_counts():
            #     if y_new_test.value_counts()[1.0] <= 15:
            #         continue
            # else :
            #     print("Key 1.0 not present in value_counts()")
            #     continue
            ...
            for k in range(1000000) :
               ...
               # Build the model
                ...
                checkpoint = ModelCheckpoint('best_weights.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1)
                ...
                # Train the model
                model.fit(x_train_reshaped, y_train, verbose = 1,epochs=100, batch_size=32, 
