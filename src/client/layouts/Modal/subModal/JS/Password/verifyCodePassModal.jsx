...
const VerifyCodePassModal = ({ onClose, onSuccess }) => {
  ...
  const handleVerifyCode = async () => {
    try {
      const response = await axios.post(
        "http://localhost:5000/api/verify-ccpass",
        {
  ...
  return (
    <div className="verify-code-modal px-20 py-10">
      <div className="modal-content">
        <h2 className="modal-title text-blue-500 font-bold text-xl text-center pt-5">Verify Changing Password</h2>
...
export default VerifyCodePassModal;