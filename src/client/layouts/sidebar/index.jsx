...
const Sidebar = () => {
  ...
  return (
    <div className="bg-[#1E2226]">
      ...
      >
        ...
        <div className="flex flex-col  h-full relative ">
          <ul className="whitespace-pre px-2.5 text-[0.9rem] py-5 flex flex-col gap-1  font-medium overflow-x-hidden scrollbar-thin scrollbar-track-white scrollbar-thumb-slate-100   md:h-[68%] h-[70%] text-[#2C7AFE]">
            ...
            <li>
              <NavLink to={"/statements"} className="link">
                <MdAnalytics size={23} className="min-w-max" />
                Statements
              </NavLink>
            </li>
            <li>
              <NavLink to={"/overall"} className="link">
                <MdAnalytics size={23} className="min-w-max" />
                Overall
              </NavLink>
            </li>
      ...
      {/* <div className="m-3 md:hidden whitespace-pre flex flex-col " onClick={() => setOpen(true)}>
        <MdMenu size={25} color={"#2C7AFE"}/> CipherTrade AI
      </div> */}
    </div>
  );
};
