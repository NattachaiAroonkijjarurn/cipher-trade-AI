...
// =============================================================================================================================
  ...
  return (
    <div className="page-container flex flex-col mt-7 w-11/12 text-white">
      ...
      <div className="filter flex flex-auto flex-wrap mt-3 mr-auto gap-5 items-center">
        ...
        {/* Bot Filter */}
        <div className="bot-filter whitespace-pre flex flex-auto items-center w-[16em] z-60 relative text-white">
      ...
      {/* Static Contanier */}
      <div className='statitic-container flex flex-col my-5 gap-5 w-full text-white'>
