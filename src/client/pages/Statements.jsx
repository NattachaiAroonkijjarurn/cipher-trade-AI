    ...
    return (
      <div className="page-container flex flex-col mt-7 ml-auto">
        ...
        <div className="filter flex flex-auto flex-wrap mt-3 mr-auto gap-5 items-center">
          ...
          {/* Date Filter */}
          <div className="date-filter text-white">
          ...
          <div className="resetButton bg-[#3a3c3d] rounded-lg flex-shrink-0 text-white">
            <button className="py-2 px-3" onClick={() => {setBotPick("All")}}>Reset</button>
          </div>
        </div>
        ...
        {selectedTab == 0 
          ? <div className="mt-3">
              <table className="text-center w-11/12 text-white text-sm font-extralight" border="1">
                ...
                <tbody>
                  {isTabletMid
                    ? tableOrderData.map((row) => (
                        <tr key={row.id}>
                          <td className="pt-2 table-row-data">{row.id}</td>
          ...
          : <div className="mt-3">
              <table className="text-center w-11/12 text-white font-extralight text-sm" border="1">
                <thead className="text-slate-500">
                  {isTabletMid
                    ? <tr className="border-y-2 border-slate-500">
                    <th className="py-2">ID</th>
